...
void Fase2::init(){
    ...
    hero = new Hero(ObjetoDeJogo("Hero", Sprite("rsc/hero.txt"), 42, 80), 30, 2);
    objs.push_back(hero);
    ...
    objs.push_back(new ObjetoDeJogo("Fase", TextSprite("2"), 4, 84));
...
void Fase2::draw(SpriteBase &screen, int x, int y){
